...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to onboarding to customize avatar
      navigate("/onboarding");
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white dark:bg-gray-900">
      ...
      <div className="hidden lg:flex w-1/2 bg-gray-900 relative overflow-hidden items-center justify-center p-12">
        {/* Animated Background - Purple/Pink Theme */}
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
            rotate: [0, -45, 0],
        ...
        <div className="relative z-10 text-center space-y-8 max-w-lg">
          ...
          <motion.div
            ...
            className="space-y-4 text-left bg-white/5 p-6 rounded-2xl backdrop-blur-sm border border-white/10"
          >
        ...
        >
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Start your adventure for free today
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-12 h-12 text-lg bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-purple-500 transition-all"
                    value={displayName}
              ...
              <Button
                className="w-full h-12 text-lg font-bold bg-purple-600 hover:bg-purple-700 shadow-lg shadow-purple-500/30 transition-all hover:-translate-y-0.5"
                type="submit"
                disabled={isLoading}
              >
                {isLoading ? (
