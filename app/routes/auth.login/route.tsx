...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const loggedInUser = await loginWithStudentId(studentId, password);
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <Button
              variant="outline"
              className="w-full h-12 text-base font-medium flex items-center gap-2 justify-center"
...
// --- MODAL COMPONENTS (Unchanged from your previous version) ---
